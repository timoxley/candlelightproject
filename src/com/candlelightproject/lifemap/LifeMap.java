...
public class LifeMap extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        contacts = getContactDataFromPhone();
        
        setupTestContactsIfNeeded();
        
        // Search and update field example:
//        int foundId = getContactId("Shin Phuong");
//        if (foundId > 0) {
//        	updateContactRecordOnPhone(foundId, People.NAME, "lolbeans");
//        }
	...
	private void updateContactRecordOnPhone(int recNo, String field, String updatedText) {
	...
	private ContactNode[] getContactDataFromPhone() {
		...
		if (managedCursor.moveToFirst()) {
	        ...
	        do {
	            ...
	            if (!StringUtils.isEmptyOrWhitespace(primaryEmail)) {
		            ...
		            Cursor emailCursor = managedQuery(email, 
	...
	private int getContactId(String aName) {
	...
	public void setupTestContactsIfNeeded() {
		...
		for (ContactNode aTestContact : testContacts) {
			...
			if (getContactId(aTestContact.getName()) == -1) {
	...
	public void createContact(String aName, String aPhoneNumber, String aEmail) {

		ContentValues values = new ContentValues();
		values.put(People.NAME, aName);
		Uri newContact = Contacts.People.createPersonInMyContactsGroup(getContentResolver(), values);
