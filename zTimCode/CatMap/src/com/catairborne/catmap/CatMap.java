...
import com.catairborne.catmap.MapView.MapThread;
 ...
 * </ul>
 */
public class CatMap extends Activity {
	/*
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        setContentView(R.layout.catmap_layout);

        // get handles to the LunarView from XML, and its LunarThread
        mMapView = (MapView) findViewById(R.id.catmap);
